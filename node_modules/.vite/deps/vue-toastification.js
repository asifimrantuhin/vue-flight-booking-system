...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(resolveDynamicComponent(_ctx.component), { class: _ctx.iconClasses }, {
    default: withCtx(() => [
      createTextVNode(
        toDisplayString(_ctx.customIconChildren),
        1
        /* TEXT */
      )
    ]),
    ...
    [
      ...
      createVNode("div", {
        ...
        typeof _ctx.content === "string" ? (openBlock(), createBlock(
          ...
          key: 1,
          "toast-id": _ctx.id
        }, _ctx.content.props, toHandlers(_ctx.content.listeners), { "onClose-toast": _ctx.closeToast }), null, 16, ["toast-id", "onClose-toast"]))
      ], 10, ["role"]),
      ...
      }, null, 8, ["is-running", "hide-progress-bar", "timeout", "onClose-toast"])) : createCommentVNode("v-if", true)
    ],
    38
...
var esm_default = VueToastificationPlugin;
export {
  EventBus,
  POSITION,
  TYPE,
