import { defineComponent, openBlock, createBlock, resolveDynamicComponent, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, resolveComponent, createCommentVNode, Fragment, toHandlers, withModifiers, TransitionGroup, renderSlot, renderList, nextTick, createApp, provide, inject } from 'vue';
  ...
  return (openBlock(), createBlock("div", {
    ...
    (_ctx.timeout)
      ? (openBlock(), createBlock(_component_ProgressBar, {
          ...
          "onClose-toast": _ctx.timeoutHandler
        }, null, 8 /* PROPS */, ["is-running", "hide-progress-bar", "timeout", "onClose-toast"]))
      : createCommentVNode("v-if", true)
...
export { EventBus, POSITION, TYPE, createToastInterface, provideToast, toastInjectionKey, useToast };
