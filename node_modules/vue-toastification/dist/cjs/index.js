    ...
    vue.createVNode("div", {
      ...
      (typeof _ctx.content === 'string')
        ...
        : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.getVueComponentFromObj(_ctx.content)), vue.mergeProps({
            key: 1,
            "toast-id": _ctx.id
          }, _ctx.content.props, vue.toHandlers(_ctx.content.listeners), { "onClose-toast": _ctx.closeToast }), null, 16 /* FULL_PROPS */, ["toast-id", "onClose-toast"]))
    ], 10 /* CLASS, PROPS */, ["role"]),
    (!!_ctx.closeButton)
...
const useToast = eventBus => {
  ...
  const toast = vue.inject(toastInjectionKey);
